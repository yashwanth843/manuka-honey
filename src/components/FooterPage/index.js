...
//             <p className='logo-text'>Colourclub members earn up to <span className='number'>56</span> reward points when buy this item. sign up or log in</p>
//         </div>
...
//                 <p className='delivery-para'>or 4 interest-free payments of $13.97 with 
//                     <img src="https://res.cloudinary.com/dlaypemls/image/upload/v1756638969/button_logo_keprxj.png" alt="log" className='logo-btn'/><RiInformationLine/></p>
//             </div>
//             <hr/>
//         </div>
//     </div>
